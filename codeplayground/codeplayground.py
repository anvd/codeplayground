...
class CodePlaygroundXBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the CodePlaygroundXBlock, shown to students
        ...
        frag.initialize_js('CodePlaygroundXBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("CodePlaygroundXBlock",
             """<codeplayground/>
             """),
            ("Multiple CodePlaygroundXBlock",
             """<vertical_demo>
                <codeplayground/>
                <codeplayground/>
                <codeplayground/>
