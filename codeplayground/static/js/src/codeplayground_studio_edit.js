...
function StudioEditableXBlockMixin(runtime, element) {
    ...
    $(element).find('.field-data-control').each(function() {
        ...
        var fieldChanged = function() {
            ...
            // language changed
            debugger;
            console.log($field.attr('id') + ' CHANGED with new value == ' + $field.val())
            if ($field.attr('id') == 'xb-field-edit-languages') {
            	console.log($field.attr('id') + ' CHANGED with new value == ' + $field.val())
            }
        };
        ...
        if (field_id == 'xb-field-edit-languages') {
        	$field.bind("change input paste", languageFieldChanged);
        } else if (field_id == 'xb-field-edit-assignments') {
        	$field.bind("change input paste", assignmentFieldChanged);
        } else {
